...
package com.simple.frameworks.processframework.utils;
...
public abstract class ReflectionUtils {
	...
	public static Field[] getAllDeclaredFields(Class<?> clazz,boolean inherienc){
		...
		if(inherienc){
			Field[] superFields=getAllDeclaredFields(clazz.getSuperclass(),inherienc);
			if(superFields!=null){
	...
	public static Method[] getMethodsByName(String name,Class<?> leafClass){
		List<Method> methodsList=new ArrayList<Method>();
		Method[] declaredMethods=getAllDeclaredMethods(leafClass);
