...
public class JavassistClassGenerator implements ClassGenerator {
	...
	static {
		javassitClassPool.importPackage("com.simple.frameworks.processframework");
		javassitClassPool
				.importPackage("com.simple.frameworks.processframework.result");
		javassitClassPool
				.importPackage("com.simple.frameworks.processframework.request");

		javassitClassPool
				.importPackage("com.simple.frameworks.processframework.invoke");
	...
	public Class<?> generateClass(ProcessHolder processHolder,
		...
		String className = "com.simple.frameworks.processframework.invoke."
