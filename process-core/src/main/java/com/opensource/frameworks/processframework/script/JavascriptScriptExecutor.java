...
public class JavascriptScriptExecutor implements ScriptExecutor {
	 ...
	 * 
	 * @see
	 * com.jd.frameworks.processframework.script.ScriptExecutor#execute(java
	 * .lang.String, com.jd.frameworks.processframework.ExecuteContext)
	 */
	@Override
	...
	public Object execute(String script, ExecuteContext context,
		...
		engine.put("parameters", context.request.getParameterMap());
		engine.put("attributes", context.session.getAttributes());
