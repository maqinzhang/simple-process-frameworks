 ...
 *
 */
public class ElseTagParser extends BaseTagParser<ElseTagConfig>{

	@Override
	protected ElseTagConfig doParse(Element e,List<Element> childElements,
			ElseTagConfig config) {
	...
	@Override
	protected ElseTagConfig createObject() { 
		return new ElseTagConfig();
	}
