 ...
 * 
 */
public class WhenTagParser extends BaseTagParser<IfTagConfig> {

	@Override
	protected IfTagConfig doParse(Element e,
			List<Element> childElements, IfTagConfig ifConfig) {  
	...
	@Override
	protected IfTagConfig createObject() {
		return new IfTagConfig();
	}
